...
# 	path('comment/<int:id>', views.comment, name='comment'),
    ...
    path('vendor_credit_comment/<int:id>',views.vendor_credit_comment,name = "vendor_credit_comment"),
    ...
    path('opnasc/', views.opnasc, name='opnasc'),
    ...
    path('view_opn/<int:id>/', views.view_opn, name='view_opn'),
    ...
    path('cash_to_bank_transfer/<int:id>/', views.cash_to_bank_transfer, name='cash_to_bank_transfer'),
    path('adjust_bank_balance/<int:id>/', views.adjust_bank_balance, name='adjust_bank_balance'),
    path('bank_to_bank_transfer/<int:id>/', views.bank_to_bank_transfer, name='bank_to_bank_transfer'),
    path('check_duplicate_bank/', views.check_duplicate_bank, name='check_duplicate_bank'),
    path('edit_banktocash/<int:id>', views.edit_banktocash, name='edit_banktocash'),
    path('edit_cashtobank/<int:id>', views.edit_cashtobank, name='edit_cashtobank'),
    path('edit_adjustbankbalance/<int:id>', views.edit_adjustbankbalance, name='edit_adjustbankbalance'),
    path('edit_bank_to_bank_transfer/<int:id>', views.edit_bank_to_bank_transfer, name='edit_bank_to_bank_transfer'),
    path('delete_transaction/<int:id>/', views.delete_transaction, name='delete_transaction'),
    path('active_banks/', views.active_banks, name='active_banks'),
    path('inactive_banks/', views.inactive_banks, name='inactive_banks'),
    path('active_banks_view/<int:id>/', views.active_banks_view, name='active_banks_view'),
    path('inactive_banks_view/<int:id>/', views.inactive_banks_view, name='inactive_banks_view'),
    path('sharebank/<int:id>/', views.sharebank, name='sharebank'),
    ...
    path('namesel',views.namesel,name='namesel'),
    ...
    path('sharecreditToEmail/<int:id>', views.sharecreditToEmail, name='sharecreditToEmail'),
    path('creditpdf/<int:id>',views.creditpdf,name='creditpdf'),
    path('customerdatas/',views.customerdatas,name='customerdatas'),
    path('check_invoice/', views.check_invoice, name='check_invoice'),
...
#................................  Views END ............ Godown details & project details & GSTR9...... TINTO MT .......( end )......................
    ...
    path('monthselection1',views.monthselection1,name='monthselection1'),
    path('edit_salary/<int:id>',views.edit_salary,name='edit_salary'),
    path('convert_viewsalary/<int:id>',views.convert_viewsalary,name='convert_viewsalary'),
    ...
    path('shareSalesOrderToEmailsalary/<int:id>',views.shareSalesOrderToEmailsalary,name='shareSalesOrderToEmailsalary'),
    path('delet_salary/<int:id>',views.delet_salary,name='delet_salary'),
    path('edit_salary_page/<int:id>',views.edit_salary_page,name='edit_salary_page'),
    path('salary_deatils_save/<int:id>',views.salary_deatils_save,name='salary_deatils_save'),
    path('salary_deatils_draft/<int:id>',views.salary_deatils_draft,name='salary_deatils_draft'),
    ...
    path('invoice_unit_eway',views.invoice_unit_eway,name='invoice_unit_eway'),
