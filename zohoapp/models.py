...
class Chart_of_Account(models.Model):
    user = models.ForeignKey(User,on_delete=models.CASCADE,null=True,blank=True)
    company = models.ForeignKey(company_details, on_delete=models.CASCADE,null=True)
    ...
    status = models.CharField(max_length=255,null=True,blank=True)
    user_modification = models.BooleanField(default=False)
...
class transactions(models.Model):
    user=models.ForeignKey(User,on_delete=models.CASCADE)
    bank=models.ForeignKey(Bankcreation, on_delete=models.CASCADE,null=True, blank=True, related_name='bank_transactions')
    fromB=models.ForeignKey(Bankcreation, on_delete=models.CASCADE,null=True, blank=True,related_name='from_transactions')
    toB=models.ForeignKey(Bankcreation, on_delete=models.CASCADE,null=True, blank=True,related_name='to_transactions')
    amount = models.FloatField(null=True, blank=True)
    date = models.DateField(null=True, blank=True)
    ...
    adjacname=models.ForeignKey(Bankcreation, on_delete=models.CASCADE,null=True, blank=True, related_name='adjacname_transactions')
    name=models.CharField(max_length=220,default='', null=True, blank=True) 
    balance=models.FloatField(default=0.0,null=True, blank=True)
...
class salaryd(models.Model):
    user=models.ForeignKey(User,on_delete=models.CASCADE,null=True,blank=True)
    employee_name=models.ForeignKey(Payroll,on_delete=models.CASCADE,null=True,blank=True)
    ...
    employee_salary=models.FloatField(null=True, blank=True)
    ...
    employee_basicsalary=models.FloatField(null=True, blank=True)
    employee_Allowance=models.FloatField(null=True, blank=True)
    employee_HRA=models.FloatField(null=True, blank=True)
    employee_otherall=models.FloatField(null=True, blank=True)
    employee_Bonus=models.FloatField(null=True, blank=True)
    employee_othercuttings=models.FloatField(null=True, blank=True)
    employee_Tsalary=models.FloatField(null=True, blank=True)
